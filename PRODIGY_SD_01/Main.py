...
btn = Button(root, text="Submit", fg="blue", command=clicked)
btn.grid(column=1, row=2)

lbl_1 = Entry(root,width=10, fg='black',font=('Arial',16,'bold'))
lbl_1.insert(0,"")
lbl_1.grid(column=0, row=3)
lbl_2 = Entry(root,width=10, fg='black',font=('Arial',16,'bold'))
lbl_2.insert(0,"")
lbl_2.grid(column=1, row=3)
lbl_3 = Entry(root,width=10, fg='black',font=('Arial',16,'bold'))
lbl_3.insert(0,"")
lbl_3.grid(column=0, row=4)
lbl_4 = Entry(root,width=10, fg='black',font=('Arial',16,'bold'))
lbl_4.insert(0,"")
